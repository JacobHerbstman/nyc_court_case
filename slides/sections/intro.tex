...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item However, centralized decision-making can miss local information about congestion, neighborhood amenities, and other real costs of density \cite{jacobs_life_1961,gyourko_distaste_2024}
        \end{itemize}
        \item Theoretically ambiguous which level of centralization is ``optimal'' and may depend on how a social planner weights incumbents vs. potential entrants, and how much local information is relevant for land-use decisions
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item In practice, the mayor made most land-use decisions
    \end{itemize}
    \end{itemize}
\end{frame}
