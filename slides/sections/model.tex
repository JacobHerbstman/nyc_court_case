...
\begin{frame}[t]
    \frametitle{A minimal spatial model with politics}
    ...
    \begin{itemize}
        ...
        \only<2->{
        \item \alert<2>{\textbf{Households}} \(g \in \{O,R,F\}\)
        \only<2>{
            \begin{itemize}
                \footnotesize
                \item Owners \(O\), incumbent renters \(R\), future residents \(F\).
                ...
                \[
                    ...
                    \varepsilon_{gj}
                \]
                \item \(C_j(q_j)\) lets local opposition reflect real neighborhood costs.
            \end{itemize}
        }
        }
        ...
        \only<5>{
            \begin{itemize}
                \footnotesize
                \item Developers propose projects.
...
\begin{frame}[t]
    ...
    \begin{itemize}
        ...
        \only<1>{
            \begin{itemize}
                \footnotesize
                \item A project is socially valuable if:
                \[
                    B_j^L + B_j^E - C_j - K_j \geq 0
                \]
                \item \(B_j^L\): local benefits.
                \item \(B_j^E\): external citywide benefits.
                \item \(C_j\): true local cost.
                \item \(K_j\): resource/construction cost.
            \end{itemize}
        }
        }
        ...
        \only<2>{
            \begin{itemize}
                ...
                \[
                    \widetilde{B}_j^L - C_j - K_j \geq 0
                \]
                \item Strength: local information.
                \item Weakness: ignores citywide and future-resident benefits.
            \end{itemize}
        }
        }
        ...
        \only<3>{
            \begin{itemize}
                ...
                \[
                    B_j^L + B_j^E - \widetilde{C}_j - K_j \geq 0
                \]
        ...
        \only<4>{
            \begin{itemize}
                ...
                \item Benefits to future residents.
        ...
        \only<5>{
            \begin{itemize}
                ...
                \item Renters, future residents, and nonlocal beneficiaries may be underweighted.
        ...
        \only<6->{
        \item \alert<6>{\textbf{Information wedge:} \(C_j - \widetilde{C}_j\)}
        \only<6>{
            \begin{itemize}
                \footnotesize
    ...
    \only<7>{
        ...
        \begin{block}{Regime tradeoff}
            \vspace{.5em}
            \footnotesize
            Centralization solves the externality and representation problems, but may create an information problem. Decentralization uses local information, but may ignore citywide benefits and underrepresented residents.
        \end{block}
