...
they point the script to likely locations and source records, but they are not
accepted on their own. A row is verified only when an official Legistar record
...
AI-suggested districts remain unresolved.
...
runtime is about 1.5 minutes when filling the official-page cache and about 15
