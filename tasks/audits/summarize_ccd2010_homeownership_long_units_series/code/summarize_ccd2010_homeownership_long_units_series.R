# setwd("/Users/jacobherbstman/Desktop/nyc_court_case/tasks/audits/summarize_ccd2010_homeownership_long_units_series/code")
...
if (nrow(brooklyn_rank_units_df) != 16) {
