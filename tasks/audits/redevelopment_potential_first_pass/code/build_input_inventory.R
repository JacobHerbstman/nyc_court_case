...
inventory_df <- tribble(
  ...
  "mappluto_field_qc", "../input/mappluto_lot_qc.csv", "csv", "archive and current release QC", nrow(read_csv("../input/mappluto_lot_qc.csv", show_col_types = FALSE, na = c("", "NA"))), "source_id; vintage; row_count; nonmissing shares", "Documents field coverage for archived and current MapPLUTO releases.",
