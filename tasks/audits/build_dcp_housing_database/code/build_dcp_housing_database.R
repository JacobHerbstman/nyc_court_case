# setwd("/Users/jacobherbstman/Desktop/nyc_court_case/tasks/audits/build_dcp_housing_database/code")
...
for (i in seq_len(nrow(raw_index))) {
  ...
  write_parquet_if_changed(project_df, out_parquet_local)
...
cat("Wrote DCP Housing Database outputs to ../output\n")
