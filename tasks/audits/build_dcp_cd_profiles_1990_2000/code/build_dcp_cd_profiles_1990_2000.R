# setwd("/Users/jacobherbstman/Desktop/nyc_court_case/tasks/audits/build_dcp_cd_profiles_1990_2000/code")
...
for (i in seq_len(nrow(raw_index))) {
  ...
  parquet_repo <- file.path("..", "..", "build_dcp_cd_profiles_1990_2000", "output", basename(parquet_local))
  unresolved_repo <- file.path("..", "..", "build_dcp_cd_profiles_1990_2000", "output", basename(unresolved_local))
  section_index_repo <- file.path("..", "..", "build_dcp_cd_profiles_1990_2000", "output", basename(section_index_local))
...
cat("Wrote DCP CD profile outputs to ../output\n")
