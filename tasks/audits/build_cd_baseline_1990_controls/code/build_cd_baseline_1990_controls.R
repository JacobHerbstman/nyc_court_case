# setwd("/Users/jacobherbstman/Desktop/nyc_court_case/tasks/audits/build_cd_baseline_1990_controls/code")
...
nhgis_files <- read_csv("../input/nhgis_files.csv", show_col_types = FALSE, na = c("", "NA")) %>%
  mutate(
    gis_zip_path = str_replace(gis_zip_path, "^\\.\\./\\.\\./\\.\\./data_raw/", "../../../../data_raw/")
  )
