...
- Heavy parsing or unzip steps should live in a dedicated `load_*_raw` task; lighter cleaning or standardization should happen downstream in a separate `build_*` task.
