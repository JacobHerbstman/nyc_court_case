        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{Why local control can be beneficial}
                \begin{itemize}
                    ...
                    \item Decentralization can screen out high-damage projects \cite{jacobs_life_1961}
                \end{itemize}
            \end{block}
        \end{column}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{Before 1989: citywide/borough-scale review}
                \begin{itemize}
                    ...
                    \end{itemize}
                    \item The 1989 Supreme Court decision \textit{Morris v. Board of Estimate} invalidated the Board's structure under the ``one person, one vote'' principle                 \end{itemize}
            \end{block}
        \end{column}
        \begin{column}{0.48\textwidth}
