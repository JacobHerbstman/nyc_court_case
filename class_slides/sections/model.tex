...
\begin{frame}[t]
    ...
    \begin{columns}[T,totalwidth=\textwidth]
        \begin{column}{0.31\textwidth}
            \begin{block}{Owners}
                \footnotesize
                Local amenities, congestion, access, and asset values \cite{ahlfeldt_economics_2015,redding_quantitative_2017}
            \end{block}
        \end{column}
        \begin{column}{0.31\textwidth}
            \begin{block}{Renters}
    ...
    \begin{columns}[T,totalwidth=\textwidth]
        \begin{column}{0.48\textwidth}
            \begin{block}{Centralized approval}
                \begin{itemize}
                    \item Internalizes citywide and entrant benefits \cite{khan_decentralized_2021,mast_warding_2024}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{Decentralized approval}
                \begin{itemize}
                    ...
                    \item May overweight incumbents and ignore spillovers \cite{fischel_homevoter_2009}
                \end{itemize}
            \end{block}
        \end{column}
    \end{columns}
